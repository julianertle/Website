...
// Usage of Logo is permitted under the license and trademark of ERPNext see https://erpnext.com/license-trademark
export const ERPNextIcon = ({ className }) => (
  <svg
    className={className}
    viewBox="0 0 48 48"
  ...
  >
    <path
      d="M0 9.6C0 4.29807 4.29807 0 9.6 0H38.4C43.7019 0 48 4.29807 48 9.6V38.4C48 43.7019 43.7019 48 38.4 48H9.6C4.29807 48 0 43.7019 0 38.4V9.6Z"
      fill="#0089FF"
    />
    <path
      clipRule="evenodd"
